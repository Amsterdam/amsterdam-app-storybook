import{r as m,S as g,k as h,j as s,V as i}from"./iframe-BxV8CBJB.js";import{H as f}from"./household-waste-to-container-DeFqSdiS.js";import"./preload-helper-Dp1pzeXC.js";const o=({aspectRatio:e="wide",height:t,children:r,...u})=>{const p=m.useMemo(()=>y({aspectRatio:e,height:t}),[e,t]),n=h(p);return s.jsx(i,{accessibilityLanguage:"nl-NL",...u,style:n.figure,children:s.jsx(i,{style:n.content,children:r})})},y=({aspectRatio:e,height:t})=>({media:r})=>g.create({figure:{flexDirection:"row",justifyContent:"center",overflow:"hidden"},content:{maxWidth:"100%",minHeight:t,aspectRatio:r.aspectRatio[e]}});try{o.displayName="Figure",o.__docgenInfo={description:`Horizontally centers media content, e.g. an image or video.
