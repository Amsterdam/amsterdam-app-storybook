...
\`\`\``,name:"navigateTo",required:!1,type:{name:"{ label: string; params: NavigateTo; }"}},title:{defaultValue:{value:"Sorry …"},description:"",name:"title",required:!1,type:{name:"string"}},variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"information"'},{value:'"negative"'},{value:'"positive"'},{value:'"warning"'}]}},retryFn:{defaultValue:null,description:"",name:"retryFn",required:!1,type:{name:"(() => void)"}},text:{defaultValue:{value:"Er ging iets mis."},description:"",name:"text",required:!1,type:{name:"string"}}}}}catch{}export{i as S};
