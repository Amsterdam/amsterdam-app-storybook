import{r as u,j as o,V as n,S as d}from"./iframe-BmRCQnP-.js";import{u as p}from"./useThemable-B2G0Gjai.js";import{S as m}from"./household-waste-to-container-CYnXEda3.js";import"./preload-helper-Zf8nSx-t.js";const s=({aspectRatio:e="wide",height:t,children:r,...c})=>{const l=u.useMemo(()=>g({aspectRatio:e,height:t}),[e,t]),i=p(l);return o.jsx(n,{accessibilityLanguage:"nl-NL",...c,style:i.figure,children:o.jsx(n,{style:i.content,children:r})})},g=({aspectRatio:e,height:t})=>({media:r})=>d.create({figure:{flexDirection:"row",justifyContent:"center",overflow:"hidden"},content:{maxWidth:"100%",minHeight:t,aspectRatio:r.aspectRatio[e]}});try{s.displayName="Figure",s.__docgenInfo={description:`Horizontally centers media content, e.g. an image or video.
