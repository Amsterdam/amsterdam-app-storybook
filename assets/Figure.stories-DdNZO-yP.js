import{r as m,j as o,V as n,S as g}from"./iframe-BI9KqfSH.js";import{u as h}from"./useThemable-C7ZAITeI.js";import{S as f}from"./household-waste-to-container-Dlen4FG8.js";import"./preload-helper-Dp1pzeXC.js";const s=({aspectRatio:e="wide",height:t,children:r,...d})=>{const p=m.useMemo(()=>y({aspectRatio:e,height:t}),[e,t]),i=h(p);return o.jsx(n,{accessibilityLanguage:"nl-NL",...d,style:i.figure,children:o.jsx(n,{style:i.content,children:r})})},y=({aspectRatio:e,height:t})=>({media:r})=>g.create({figure:{flexDirection:"row",justifyContent:"center",overflow:"hidden"},content:{maxWidth:"100%",minHeight:t,aspectRatio:r.aspectRatio[e]}});try{s.displayName="Figure",s.__docgenInfo={description:`Horizontally centers media content, e.g. an image or video.
