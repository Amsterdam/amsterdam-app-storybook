import{r as m,j as o,V as n,S as g}from"./iframe-C_edxd9J.js";import{u as h}from"./useThemable-B8gWwVJ2.js";import{S as f}from"./household-waste-to-container-DH3YLgFl.js";import"./preload-helper-Dp1pzeXC.js";const s=({aspectRatio:e="wide",height:t,children:r,...d})=>{const p=m.useMemo(()=>y({aspectRatio:e,height:t}),[e,t]),i=h(p);return o.jsx(n,{accessibilityLanguage:"nl-NL",...d,style:i.figure,children:o.jsx(n,{style:i.content,children:r})})},y=({aspectRatio:e,height:t})=>({media:r})=>g.create({figure:{flexDirection:"row",justifyContent:"center",overflow:"hidden"},content:{maxWidth:"100%",minHeight:t,aspectRatio:r.aspectRatio[e]}});try{s.displayName="Figure",s.__docgenInfo={description:`Horizontally centers media content, e.g. an image or video.
